    ...
    if cursor is not None or page_size is not None:
        ...
        try:
            ...
            cur.execute(
                ...
                LIMIT %s OFFSET %s
                """,
                tuple(where_params + [q_clean, q_clean, q_clean, effective_limit + 1, offset]),
            )
            rows = cur.fetchall()
...
def reports_dashboard(
    ...
    try:
        ...
        borrows_by_subject = cur.fetchall()
    ...
    try:
        ...
        cur.execute(
            ...
            tuple(
                ...
                + order_params
                # paging
                + [effective_limit + 1 if cursor is not None else effective_limit, offset]
            ),
        )
...
def build_title_barcode_labels_pdf(
    ...
    base_bar_width = 0.014 * inch
    min_bar_width = 0.009 * inch
    barcode_side_padding = 6
    barcode_text_gap = 1
